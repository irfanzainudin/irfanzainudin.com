    ...
    <div className="Projects">
      ...
      <main className='Projects-main'>
        <section className='WebDev Projects-section'>
          ...
          <div>
            <Card title="Masyii" status={<FontAwesomeIcon icon={faCircleCheck} />} body="A Quran web app" />
          </div>
        </section>
        <section className='Web3 Projects-section'>
          ...
          <div>
            <Card title="Online Auction Platform" status={<FontAwesomeIcon icon={faSpinner} spin />} body="A Quran web app" />
            <Card title="DeFi" status={<FontAwesomeIcon icon={faSpinner} spin />} body="A Quran web app" />
          </div>
        </section>
        {/* <section className='GameDev Projects-section'>
          <h3>Game Dev <FontAwesomeIcon icon={faGamepad} /></h3>
          <div>
            <Card title="7 Skelly Sins" status={<FontAwesomeIcon icon={faSpinner} spin />} body="A Quran web app" />
        ...
        <section className='Misc. Projects-section'>
          <h3>Miscellaneous</h3>
          <div>
            <Card title="7 Skelly Sins" status={<FontAwesomeIcon icon={faCircleCheck} />} body="A Quran web app" />
            <Card title="Visual Novel" status={<FontAwesomeIcon icon={faSpinner} spin />} body="A Quran web app" />
            <Card title="VC" status={<FontAwesomeIcon icon={faSpinner} spin />} body="A Quran web app" />
            <Card title="Sayang" status={<FontAwesomeIcon icon={faSpinner} spin />} body="A Quran web app" />
