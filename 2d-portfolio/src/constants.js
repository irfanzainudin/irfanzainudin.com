...
export const dialogueData = {
  pc: `This is my PC. I work mostly in JavaScript/TypeScript and Python these days.
    I've made a couple of games in that language. I also like C and Rust. Honourable mention is Dafny because I was fascinated by it when I learned it in university. Anyway regardless of the language, I just like programming.
    Here is my <a href="https://github.com/irfanzainudin" target="_blank">Github</a>!`,
  ...
  exit: `If you want to exit Irfan Zainudin's portfolio, just close the tab.`,
};
